...
## Description
This program calculates the distance between two point (x1,y1) and (x2,y2) on a 2D plane using input values and a math library.
...
## Author
Name: Abbe Jenielle Ann S. Veloria
Section: 8 - Gumamela
